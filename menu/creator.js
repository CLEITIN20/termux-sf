...
├── _Example: ${prefix}quotemaker Farhan/Farhan/aleatória_
┠≽ *${prefix}nulis text*
├── _Example: ${prefix}nulis Farhan Gans_
┠≽ *${prefix}croman TEXT e Amigo*
├── _Example: ${prefix}croman Farhan & Friend_
┠≽ *${prefix}slide TEXT*
├── _Example: ${prefix}slide Farhan e amigo_
┠≽ *${prefix}trigger*
├── _Example: reply Imagem e legenda ${prefix}trigger_
┠≽ *${prefix}wasted*
├── _Example: reply Imagem e legenda ${prefix}wasted_
┠≽ *${prefix}pelangi*
├── _Example: reply Imagem e legenda ${prefix}pelangi_
┠≽ *${prefix}sepia*
├── _Example: reply Imagem e legenda ${prefix}sepia_
┠≽ *${prefix}merah*
├── _Example: reply Imagem e legenda${prefix}merah_
┠≽ *${prefix}hijau*
├── _Example: reply Imagem e legenda ${prefix}hijau_
┠≽ *${prefix}biru*
├── _Example: reply Imagem e legenda ${prefix}biru_
┠≽ *${prefix}glass*
├── _Example: reply Imagem e legenda ${prefix}glass_
├───────────────────
┠≽ *${prefix}listephoto*
├── _Exemplo: para exibir a lista de ephoto_
┠≽ *${prefix}ephoto 1 - 216*
├── _Example: ${prefix}ephoto 5 Farhan_
┠≽ *${prefix}listtextpro*
├── _Exemplo: para exibir o texto da lista pro_
┠≽ *${prefix}textpro 1 - 162*
├── _Example: ${prefix}textpro 1 Farhan_
┠≽ *${prefix}fbgoldbutton TEXT*
├── _Exemplo: ${prefix}fbgoldbutton Farhan_
┠≽ *${prefix}tahta TEXTO*
├── _Exemplo: ${prefix}tahta Farhan_
┠≽ *${prefix}cglitch TEXT/TEXT*
├── _Exemplo: ${prefix}cglitch Farhan / Gans_
┠≽ *${prefix}cglass TEXT*
...
├───────────────────
┠≽ *${prefix}stiker*
├── _Examplo envie uma foto com a legenda ${prefix}stiker_
┠≽ *${prefix}toimg*
├── _Exemplo: marque uma foto e digita  ${prefix}toimg_
┠≽ *${prefix}tovideo*
...
├───────────────────
┠≽ *${prefix}slow*
├── _Example: resposta de áudio/vídeos e legendas ${prefix}slow_
┠≽ *${prefix}gemuk*
